    ...
    >
      <defs>
        ...
        <motion.path 
          ...
          transition={{ duration: 1, delay: (props.delay + 1) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ duration: 1, delay: (props.delay + 1.2) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ duration: 1, delay: (props.delay + 1.3) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ duration: 1, delay: (props.delay + 1.4) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ duration: 1, delay: (props.delay + 1.5) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ duration: 1, delay: (props.delay + 1.6) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ flip: Infinity, duration: 2, delay: (props.delay + 1.7) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ flip: Infinity, duration: 2.1, delay: (props.delay + 2) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ flip: Infinity, duration: 2.2, delay: (props.delay + 2.3) }}
        ...
        <motion.path
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ flip: Infinity, duration: 2.3, delay: (props.delay + 2.6) }}
